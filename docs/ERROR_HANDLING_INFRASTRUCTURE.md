...
**Status:** Implemented (Phase 1–2); Phase 3 in progress
**Created:** 2025-10-20
...
- Phase 1–2 complete (infrastructure + initial migrations). IVFAppend, KMeansSeeding,
  and VIndexContainerBuilder now use `VectorIndexError`.
- Phase 3 ongoing: VIndexMmap and remaining kernel audits.
